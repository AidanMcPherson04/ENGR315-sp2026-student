...
### YOUR CODE HERE
stdlistA = np.std(random_list_A)
stdlistB = np.std(random_list_B)

##Compare the standard deviations
if stdlistA > stdlistB:
            largeststd = random_list_A
else:       largeststd = random_list_B
